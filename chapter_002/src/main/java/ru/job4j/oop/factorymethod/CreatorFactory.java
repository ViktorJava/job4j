...
/**
 * Сама фабрика с конвеерами, производственными линиями
 * реализующими технологический процесс по производству воды.
 * В методе create() реализованы производственные мощностя.
 * Конструктор- это дтспетчер, принимающий команду на
 * производство необходимой продукции.
 * Заявка на производсто в виде флага, передаётся администрации
