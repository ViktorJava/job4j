...
/**
 * ТЗ [#173374]:игровое поле представляет из себя массив заполненный
 * символами '_'(подчеркивание) и 'X' - крестик. Цель игры расположить
 * крестики в линию на 5 элементов. Линия может быть горизонтальная
 * или вертикальная. Задачей будет написать метод, который будет проверять,
